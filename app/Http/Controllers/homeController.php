...
class homeController extends Controller
{
    public function index(){
        ...
        return view('home',['produks' => $produks, 'katProduks' => $katProduk]);
    }
    ...
    public function detailProduk($id_produk){
        ...
        if(session('jabatan') == 'franchisor' && $produk->id_frans == session('user')->id_frans){
            ...
            //     ]
            // ];
            // dd($produk->agen_tertarik()[1]->agen->bintang($produk->agen_tertarik()[1]->agen->id_agen));
            // return view('detail_franchisor',['brand'=>$brand,'agens'=>$agens, 'produk' => $produk, 'pakets' => $pakets]);
            return view('detail_franchisor',['agens'=>$produk->agen_tertarik(),'produk' => $produk, 'pakets' => $produk->paket]);
            ...
            return view('detail_agen',['produk' => $produk, 'pakets' => $produk->paket, 'partnership' => $partnership]);
        }else{
            // $brand=[
            //     'nama_brand'=>'Passion Of Chocolate',
            //     'path_foto_brand'=>'images/frens_product_1.jpg',
            ...
            return view('detail',['produk' => $produk, 'pakets' => $produk->paket]);
        }
    }
}
